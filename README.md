...
本项目是 **QuantStrat** 与**伊利诺伊大学金融工程硕士项目（UIUC MSFE）** 2026年夏季的量化金融研究合作项目。项目主要针对**中国商品期货市场主力合约**，严格采用科学研究范式与学术规范，以文献理论为锚进行复现与拓展检验。同时，为满足项目大纲中针对加密资产定价领域的学术研究要求，项目将相关大宗商品定价与行为折价逻辑延伸测试至加密货币资产，完成了对三篇大纲指定文献的学术复刻。项目构建了一套包含**商品期货行为金融异象、高阶异方差频域检验、动态风险管理以及加密资产下沿估值**的量化研究参考系统。

目前项目已基本完成三大核心研究模块的开发与实证分析（以中国商品期货主力合约研究为主体，加密货币定价作为大纲要求的延伸学术复刻），并规划了未来深入研究的三个学术方向。
...
### 3. Crypto_Pricing —— 加密货币定价与下沿估值 (大纲文献学术复刻)
