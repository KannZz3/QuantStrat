...
本项目是 **QuantStrat** 与**伊利诺伊大学金融工程硕士项目（UIUC MSFE）** 2026年夏季的量化金融研究合作项目。项目主要针对**中国商品期货市场主力合约**，严格采用科学研究范式与学术规范，以文献理论为锚进行复现与拓展检验；同时将资产定价层面的逻辑延伸测试至加密货币资产。项目构建了一套包含**商品期货行为金融异象、高阶异方差频域检验、动态风险管理以及加密资产下沿估值**的量化研究系统。

目前项目已基本完成三大核心研究模块的开发与实证分析（以中国商品期货主力合约研究为主体，加密资产为侧面延伸），并规划了未来深入研究的三个学术方向。
...
### 3. Crypto_Pricing —— 加密货币多维定价与下沿估值 (侧面延伸测试)
*   **研究背景**：复刻与拓展 **Bhambhwani et al. (2019)**（链上基本面与网络价值锚）、**Biais et al. (2023)**（均衡交易便利收益与成本折价）以及 **Liu & Tsyvinski (2021)**（动量与注意力溢价）三篇顶尖学术文献，将资产定价层面的验证逻辑延伸测试至加密货币（BTC）资产，探索其在缺乏传统贴现模型时的合理下沿估值区间。
*   **框架与流程**：
...
├── Crypto_Pricing—— 加密货币定价/                     # 模块三：BTC多维定价与下沿估值模块（侧面延伸）
